...
class CarRentalSystem {
    ...
    public void menu() {
        ...
        while (true) {
            System.out.println("_____ Car Rental System _____");
...
public class Main{
    public static void main(String[] args) {
        ...
        Car car4 = new Car("C004", "Tata", "Safari", 2000.0);
        Car car5 = new Car("C005", "Tata", "Harrier", 2500.0);
        RSystem.addCar(car1);
        RSystem.addCar(car2);
        RSystem.addCar(car3);
        RSystem.addCar(car4);
